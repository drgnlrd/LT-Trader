<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="product_summary.aspx.cs" Inherits="L_T_traders.product_summary" %>
...
<div id="mainBody">
	...
	<h3>  SHOPPING CART [ <small>3 Item(s) </small>]<a href="Default.aspx" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
	<hr class="soft">
